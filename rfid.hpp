...
namespace p44 {
  ...
  class RFID522 : public P44Obj
  {
    ...
    /// @param aReaderSelect index of reader to select, RFID522::Deselect = none selected
    typedef boost::function<void (int aReaderSelect)> SelectCB;
  ...
  public:
    ...
    /// @param aSpiBusAndCSNo the SPI bus (10s) and CS number (1s) combined
    /// @param aSelectAddress the selection address of this reader
    /// @param aReaderSelectFunc will be called to select this particular reader by aSelectAddress
    RFID522(int aSpiBusAndCSNo, int aSelectAddress, SelectCB aReaderSelectFunc);
